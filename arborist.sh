...
sudo -E make weekly IEDB_MYSQL_HOST="$IEDB_MYSQL_HOST" IEDB_MYSQL_PORT="$IEDB_MYSQL_PORT" IEDB_MYSQL_DATABASE="$IEDB_MYSQL_DATABASE" IEDB_MYSQL_USER="$IEDB_MYSQL_USER" IEDB_MYSQL_PASSWORD="$IEDB_MYSQL_PASSWORD"
